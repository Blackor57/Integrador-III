                ...
                .authorizeHttpRequests(authRequest ->
                                    authRequest.requestMatchers("/auth/**").permitAll()
                                        ...
                                        .requestMatchers("/receta/**").permitAll()
                                            ...
                                            .requestMatchers("/usuario").hasRole("ROLE_USER")
                                            .requestMatchers("/admin/**").hasRole("ROLE_ADMIN")
                                            .requestMatchers("/barman/**").hasRole("ROLE_BARMAN")
                                            .requestMatchers("/cocina/**").hasRole("ROLE_COCINA")
                                            .requestMatchers("/caja/**").hasRole("ROLE_CAJA")
                                            .requestMatchers("/mozo/**").hasRole("ROLE_MOZO")
